...
const file_student_v1_error_reason_proto_rawDesc = "" +
	"\n" +
	"\x1dstudent/v1/error_reason.proto\x12\rhelloworld.v1*:\n" +
	"\vErrorReason\x12\x17\n" +
	"\x13GREETER_UNSPECIFIED\x10\x00\x12\x12\n" +
	"\x0eUSER_NOT_FOUND\x10\x01BA\n" +
	"\rhelloworld.v1P\x01Z\x1cstudent/api/helloworld/v1;v1\xa2\x02\x0fAPIHelloworldV1b\x06proto3"

var (
	file_student_v1_error_reason_proto_rawDescOnce sync.Once
	file_student_v1_error_reason_proto_rawDescData []byte
)

func file_student_v1_error_reason_proto_rawDescGZIP() []byte {
	file_student_v1_error_reason_proto_rawDescOnce.Do(func() {
		file_student_v1_error_reason_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_student_v1_error_reason_proto_rawDesc), len(file_student_v1_error_reason_proto_rawDesc)))
	})
...
var file_student_v1_error_reason_proto_goTypes = []any{
...
func file_student_v1_error_reason_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_student_v1_error_reason_proto_rawDesc), len(file_student_v1_error_reason_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
